...
Broker.prototype.onError = function (error) {
  console.error('An error occurred with the broker socket, we shutdown; Reason :', error);
  process.exit(1);
};
 ...
 * @returns {Object}
 */
Broker.prototype.addEnvelope = function (message, connection, messageType) {
  return {
